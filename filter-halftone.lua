...
function script_description()
  ...
  <p>This Lua script adds a video filter named <it>Halftone</it>. It can be 
  added to a video source to reduce the number of colors of the input picture. 
  It reproduces the style of a magnified printed picture.</p>]]
end
...
-- Defintions of the glibal variable containing the source_info structure
source_info = {}
source_info.id = 'filter-halftone'              -- unique str id of source type
...
source_info.get_properties = function(data)
    ...
    obs.obs_properties_add_int_slider(props, "number_of_colour_levels", "Number of color levels", 2, 10, 1)
    return props
end
