...
pixel_data vertex_shader_a_3(vertex_data vertex)
{
    pixel_data pixel;
...
float4 pixel_shader_a_3(pixel_data pixel) : TARGET
{
...
technique Draw
{
    pass
    {
        vertex_shader = vertex_shader_a_3(vertex);
        pixel_shader  = pixel_shader_a_3(pixel);
    }
}