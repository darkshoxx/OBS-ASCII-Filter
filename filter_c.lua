...
function script_description()
    return [[<center><h2>Example Filter Phase C</h2></center>
    <p>This is Phase C of making an ASCII shader filter 
...
source_info.create = function(settings, source)
    ...
    local effect_file_path = script_path() .. 'filter_c.effect.hlsl'
