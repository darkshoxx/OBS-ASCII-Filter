...
source_info.get_properties = function(data)
    ...
    obs.obs_properties_add_int_slider(props, "cells_h", "Number of cells per row", 1, 320, 1)
    obs.obs_properties_add_int_slider(props, "cells_v", "Number of cells per column", 1, 180, 1)
