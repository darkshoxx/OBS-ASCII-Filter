...
source_info.create = function(settings, source)
    ...
    if data.effect == nil then
        ...
        data.params.mip_bias = obs.gs_effect_get_param_by_name(data.effect, "mip_bias")
...
source_info.video_render = function(data)
    ...
    obs.gs_effect_set_float(data.params.mip_bias, data.mip_bias)
...
source_info.get_defaults = function(settings)
    ...
    obs.obs_data_set_default_double(settings, "mip_bias", 0.75)
    obs.obs_data_set_default_bool(settings, "dyn_sat", true)
    obs.obs_data_set_default_bool(settings, "dyn_val", false)
end
...
source_info.get_properties = function(data)
    ...
    obs.obs_properties_add_float_slider(props, "mip_bias", "bias for kernel", 0.0, 4.0, 0.1)
...
source_info.update = function(data, settings)
    ...
    data.mip_bias = obs.obs_data_get_double(settings, "mip_bias")
